...
const MarkCard: React.FC<MarkCardProps> = ({ data }) => {
  ...
  return (
    <Link
      href={`/details?data=${serializedData}`}
      ...
      <div className="grid grid-cols-4 bg-white shadow-md rounded-lg hover:bg-gray-500">
          ...
          <div className="w-30 h-30 bg-gray-100 flex items-center justify-center rounded-lg">
            ...
            >
              <g filter="url(#filter0_d_16_32)">
                ...
                />
                <path
                  d="M78.1884 50.0151C76.6443 48.471 76.6443 45.9676 78.1884 44.4235V44.4235C79.7325 42.8794 82.2359 42.8794 83.78 44.4235L84.7837 45.4272C86.3278 46.9713 86.3278 49.4747 84.7837 51.0188V51.0188C83.2396 52.5629 80.7362 52.5629 79.1921 51.0188L78.1884 50.0151Z"
                  fill="#C8C8C8"
                />
                <path
                  d="M84.2147 56.3534C83.7329 56.8351 82.9518 56.8351 82.47 56.3534C81.9882 55.8716 81.9882 55.0905 82.47 54.6087L88.3749 48.7037C88.8567 48.222 89.6378 48.222 90.1196 48.7037C90.6014 49.1855 90.6014 49.9666 90.1196 50.4484L84.2147 56.3534Z"
                  fill="#C8C8C8"
                />
                <path
                  d="M74.597 46.7356C74.1152 47.2173 73.3341 47.2173 72.8523 46.7356C72.3705 46.2538 72.3705 45.4727 72.8523 44.9909L78.7572 39.0859C79.239 38.6042 80.0201 38.6042 80.5019 39.0859C80.9837 39.5677 80.9837 40.3488 80.5019 40.8306L74.597 46.7356Z"
                  fill="#C8C8C8"
                />
                <path
                  d="M77.393 50.5162C77.7512 50.1579 78.332 50.158 78.6903 50.5162V50.5162C79.0485 50.8744 79.0485 51.4553 78.6903 51.8135L69.9445 60.5588C69.5862 60.9171 69.0026 60.9143 68.6444 60.556C68.4652 60.3768 68.377 60.1436 68.377 59.9089C68.377 59.674 68.468 59.4407 68.6472 59.2615L77.393 50.5162Z"
                  fill="#C8C8C8"
                />
                <path
                  d="M79.852 60.8155C77.7412 60.8155 76.3548 58.3824 78.4656 58.3824V58.3824H90.2109V58.3824C92.3218 58.3824 90.9355 60.8155 88.8246 60.8155H79.852Z"
                  fill="#C8C8C8"
                />
                <path
                  d="M106.322 70.3493C101.611 66.461 94.5821 67.1343 90.6942 71.8446C86.8059 76.5554 87.4793 83.5842 92.1895 87.4721C96.9003 91.3604 103.929 90.6871 107.817 85.9768C111.705 81.2665 111.033 74.2378 106.322 70.3493ZM104.228 72.8915C104.228 72.8914 104.228 72.8915 104.228 72.8915C106.995 75.1348 107.817 78.9479 106.396 82.0883C106.322 82.238 106.097 82.3126 105.948 82.1629L94.8068 72.9666C94.6571 72.8169 94.6571 72.5926 94.8068 72.518C97.6483 70.5737 101.462 70.6487 104.228 72.8914C104.228 72.8914 104.228 72.8915 104.228 72.8915V72.8915ZM94.2833 85.005C94.2833 85.005 94.2833 85.005 94.2833 85.005C91.5168 82.7617 90.6944 78.9486 92.1152 75.8081C92.1897 75.6584 92.414 75.5838 92.5637 75.7335L103.78 84.9304C103.929 85.0801 103.929 85.3044 103.78 85.379C100.938 87.3229 97.0504 87.2483 94.2834 85.005C94.2834 85.005 94.2833 85.005 94.2833 85.005V85.005Z"
                  fill="#C8C8C8"
                />
              </g>
              <defs>
                ...
                >
                  ...
                  <feColorMatrix
                    type="matrix"
                    values="0 0 0 0 0.368627 0 0 0 0 0.368627 0 0 0 0 0.368627 0 0 0 1 0"
                  />
                  <feBlend
                    mode="normal"
                    in2="BackgroundImageFix"
                    result="effect1_dropShadow_16_32"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_dropShadow_16_32"
                    result="shape"
                  />
                </filter>
              </defs>
        ...
        <div className="col-span-1 flex flex-col justify-between">
          <div className="flex items-center space-x-2 mb-2">
            <span
              className={`${
                status_type === "registered" ? "text-green-600" : "text-red-600"
              } font-bold text-sm`}
            >
              ●{" "}
          ...
          <div className="flex items-center space-x-2 mb-2">
            <p className="text-black font-bold text-sm">
              on {new Date(registration_date * 1000).toLocaleDateString()}
            </p>
          </div>
          <div className="flex items-center space-x-2 mb-2">
              ...
              <div className="space-y-1">
                {class_codes.map((code, index) => (
                  <div key={index} className="flex items-center space-x-2">
                    <i className="fas fa-gavel text-black">
                      <svg
                        width="18"
                        height="22"
                        viewBox="0 0 18 22"
