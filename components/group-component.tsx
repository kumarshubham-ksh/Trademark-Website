...
const GroupComponent: NextPage<GroupComponentType> = ({
  ...
  return (
    <header
      className={`mr-[-30px] w-[1600px] bg-ghostwhite flex flex-col items-start justify-start pt-[20px] px-0 pb-[0.4px] box-border gap-[30.5px] max-w-[103%] shrink-0 text-left text-sm text-white font-questrial mq750:gap-[15px] ${className}`}
    >
      ...
      <div className="w-[1419px] flex flex-row items-start justify-start py-0 px-[78px] box-border max-w-full mq1225:pl-[39px] mq1225:pr-[39px] mq1225:box-border">
        <div className="flex-1 flex flex-row items-start justify-between max-w-full gap-5 mq1225:flex-wrap">
          <div className="w-[1000px] flex flex-col items-start justify-start pt-[1.3px] px-0 pb-0 box-border max-w-full">
            <div className="self-stretch flex flex-col items-start justify-start max-w-full">
              <div className="flex flex-row items-start justify-start gap-[31px]">
                <div className="cursor-pointer relative font-semibold z-[1]">
                  Call Us: 1-877-794-9511
                </div>
                <a className="cursor-pointer [text-decoration:none] relative font-semibold text-[inherit] inline-block min-w-[55px] z-[1]">
                  Email Us
                </a>
              </div>
              <div className="self-stretch flex flex-row items-start justify-start gap-[49.3px] max-w-full mt-[-2.7px] mq750:flex-wrap mq450:gap-[25px]">
                <div className="w-[155.4px] flex flex-col items-start justify-start pt-3.5 px-0 pb-0 box-border">
                  <img
                    className="cursor-pointer self-stretch h-[21.9px] relative max-w-full overflow-hidden shrink-0 object-cover z-[1]"
                    loading="lazy"
                    alt="Company Logo"
                    src="/logo@2x.png"
                  />
                ...
                <div className="flex-1 flex flex-row items-start justify-start gap-3 min-w-[384px] max-w-full mq750:flex-wrap mq750:min-w-full">
                  <div className="flex-1 rounded-xl bg-white border-lightgray-100 border-[1px] border-solid box-border flex flex-row items-start justify-start pt-[7px] px-[15px] pb-2 gap-2 min-w-[292px] max-w-full z-[1]">
                    ...
                    <input
                      ...
                      className="w-[268px] [border:none] [outline:none] font-medium font-questrial text-sm bg-[transparent] h-[31px] relative leading-[30.96px] text-dimgray-100 text-left flex items-center justify-center p-0 z-[1]"
          ...
          <nav className="m-0 h-[17px] w-[301px] relative text-left text-sm text-white font-questrial">
            <a className="cursor-pointer [text-decoration:none] absolute top-[0px] left-[0px] font-semibold text-[inherit] inline-block min-w-[54px] z-[1]">
              Services
            </a>
            <a className="cursor-pointer [text-decoration:none] absolute top-[0px] left-[86px] font-semibold text-[inherit] inline-block min-w-[62px] z-[1]">
              Attorneys
            </a>
            <a className="cursor-pointer [text-decoration:none] absolute top-[0px] left-[180px] font-semibold text-[inherit] inline-block min-w-[53px] z-[1]">
              Support
            </a>
            <a className="cursor-pointer [text-decoration:none] absolute top-[0px] left-[265px] font-semibold text-[inherit] inline-block min-w-[36px] z-[1]">
              Login
            </a>
          </nav>
        </div>
